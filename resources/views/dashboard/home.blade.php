        ...
        <main class="flex-1 p-4 md:p-6">
            ...
            <div class="mb-8">
                <div class="flex flex-wrap gap-4">
                    <a href="{{ route('dashboard.create-quiz') }}" class="flex-1 min-w-[200px] bg-blue-600 text-white p-4 rounded-lg shadow hover:bg-blue-700 transition">
                    ...
                    <a href="{{ route('dashboard.statistics') }}" class="flex-1 min-w-[200px] bg-green-600 text-white p-4 rounded-lg shadow hover:bg-green-700 transition">
